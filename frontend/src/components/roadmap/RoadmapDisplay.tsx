        ...
        <div className="max-w-4xl mx-auto">
          <div className="space-y-12">
            {roadmap.phases.map((phase, phaseIndex) => {
              ...
              const isEvenPhase = phaseIndex % 2 === 0
                ...
                <div key={phase.phase_number} className="relative">
                  ...
                  <div className="flex justify-center mb-8">
                    <button
                      ...
                      className={`relative bg-white border-2 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-200 w-96 ${
                  ...
                  {/* Milestones - Directly from phase box sides */}
                  <div className="relative">
                    <div className="flex items-center justify-center">
                      {/* Left side milestones (for odd phases - phase 1, 3, 5...) */}
                      {!isEvenPhase && (
                        <div className="flex flex-col space-y-4 w-80 mr-4">
                          {phase.milestones.map((milestone, milestoneIndex) => (
                            <div key={milestoneIndex} className="relative">
                              {/* Direct connection line to phase box */}
                              <div className="absolute top-1/2 right-0 w-4 h-px bg-gray-300 transform translate-x-full -translate-y-1/2" />
                      ...
                      <div className="w-96 flex justify-center">
                        {/* Phase box is already rendered above, this is just for spacing */}
                      </div>

                      {/* Right side milestones (for even phases - phase 2, 4, 6...) */}
                      {isEvenPhase && (
                        <div className="flex flex-col space-y-4 w-80 ml-4">
                          {phase.milestones.map((milestone, milestoneIndex) => (
                            <div key={milestoneIndex} className="relative">
                              {/* Direct connection line to phase box */}
                              <div className="absolute top-1/2 left-0 w-4 h-px bg-gray-300 transform -translate-x-full -translate-y-1/2" />
                  ...
                  {/* Bigger Arrow to Next Phase - No gap */}
                  {!isLastPhase && (
                    <div className="flex justify-center -mt-4 mb-4">
                      <div className="flex flex-col items-center">
                        <div className="w-px h-8 bg-gray-300" />
                        <ArrowDownIcon className="w-8 h-8 text-gray-500 bg-white border-2 border-gray-300 rounded-full p-1" />
                        <div className="w-px h-8 bg-gray-300" />
                      </div>
                    </div>
                  )}
